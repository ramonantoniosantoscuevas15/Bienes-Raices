        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/blog1.jpg" alt="Texto Entrada Bloc">
                </picture>
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/blog2.jpg" alt="Texto Entrada Bloc">
                </picture>
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/blog3.jpg" alt="Texto Entrada Bloc">
                </picture>
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/blog4.jpg" alt="Texto Entrada Bloc">
                </picture>
